-- ========================================================
-- IRONPIXELS PRISTINE DATABASE CLEANUP & DROP LEGACY TABLES
-- Removes all unused legacy tables & wipes data clean like brand new
-- ========================================================

-- 1. DROP ALL UNUSED LEGACY TABLES
DROP TABLE IF EXISTS public."Users" CASCADE;
DROP TABLE IF EXISTS public."User_Stats" CASCADE;
DROP TABLE IF EXISTS public."user_stats" CASCADE;
DROP TABLE IF EXISTS public."Dungeon_Bosses" CASCADE;
DROP TABLE IF EXISTS public."dungeon_bosses" CASCADE;
DROP TABLE IF EXISTS public."legacy_parties" CASCADE;
DROP TABLE IF EXISTS public."legacy_members" CASCADE;

-- 2. ENSURE OFFICIAL PRODUCTION TABLES SCHEMA ARE NEAT & PRISTINE
...
-- 3. TRUNCATE ALL ACTIVE DATA (BRAND NEW CLEAN STATE)
...
TRUNCATE TABLE public."Party_Members" CASCADE;
TRUNCATE TABLE public."Party" CASCADE;
TRUNCATE TABLE public."friends" CASCADE;
TRUNCATE TABLE public."profiles" CASCADE;

-- 4. SEED EXERCISE DICTIONARY REFERENCE DATA
...
ALTER TABLE public."Equipped_Gear" ENABLE ROW LEVEL SECURITY;
